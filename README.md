...
Проверялось на chrome: macOS и iOS
Задание выполненно в одном файле, т.к. цель была познакомится с media api
Запуск проекта не отличается от запуска до моих изменений
